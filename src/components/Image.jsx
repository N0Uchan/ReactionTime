...
import img7 from "../assets/cat (7).jpg";
import img8 from "../assets/cat (8).jpg";
import img9 from "../assets/cat (9).jpg";
import img10 from "../assets/cat (10).jpg";
import img11 from "../assets/cat (11).jpg";
const imgList = [
  img1,
  img2,
  img3,
    ...
    <>
      ...
      {imgList.map((imgSrc, index) => (
        <img
          key={index}
          src={imgSrc}
          alt={`image of a cat ${index + 1}.`}
          className={index === imgId - 1 ? "visibleimg" : "invisibleimg"}
        />
      ))}
    </>
  );
